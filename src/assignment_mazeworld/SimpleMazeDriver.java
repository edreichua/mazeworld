 ...
 *
 * SimpleMazeDriver for Maze World
 *
...
public class SimpleMazeDriver extends Application {
	...
	private void runSearches() {
		...
		SimpleMazeProblem mazeProblem = new SimpleMazeProblem(maze, 0, 0, 6, 0);

		/**System.out.println("Empty Maze");
		SimpleMazeProblem mazeProblem = new SimpleMazeProblem(maze, 0, 0, 6, 0);*/

		/**System.out.println("Rearrange Maze");
		SimpleMazeProblem mazeProblem = new SimpleMazeProblem(maze, 0, 0, 4, 0);*/

		/**System.out.println("Tricky Maze");
		SimpleMazeProblem mazeProblem = new SimpleMazeProblem(maze, 0, 0, 2, 0);*/

		/**System.out.println("Large Maze");
		SimpleMazeProblem mazeProblem = new SimpleMazeProblem(maze, 0, 0, 15, 0);*/
	...
	private class AnimationPath {
		...
		public void doNextMove() {
			...
			if (currentMove < searchPath.size() && animationDone) {
				...
				lastX = mazeNode.getX();
				lastY = mazeNode.getY();
				mazeView.addFootPrint(lastX,lastY,mazeView.colors[2]);
				currentMove++;
			}
